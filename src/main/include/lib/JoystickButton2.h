 ...
 * @see Trigger
 */
class JoystickButton2 : public Button {
 public:
  /**
   ...
   */
  explicit JoystickButton2(frc::GenericHID* joystick, int buttonNumber)
      : Button([joystick, buttonNumber] { return joystick->GetRawButton(buttonNumber); }) {}
};
}  // namespace frc2
