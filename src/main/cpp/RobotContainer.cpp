...
RobotContainer::RobotContainer() {
  m_autoChooser.AddOption("Shoot + Reculer",
                          new frc2::SequentialCommandGroup(PrepShoot(&m_shooter).WithTimeout(3_s),
                                                           Shoot(&m_shooter).WithTimeout(5_s),
  ...
  m_autoChooser.AddOption(
      ...
      new frc2::SequentialCommandGroup(
          ...
          AutoDrive(&m_drivetrain, -1000), PrepShoot(&m_shooter).WithTimeout(3_s),
          Shoot(&m_shooter).WithTimeout(15_s)));
